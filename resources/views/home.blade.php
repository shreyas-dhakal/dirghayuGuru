            ...
            @foreach ($doctors->slice(0, 4) as $doctor)
                <div class="col-lg-6 mt-4">
                    <div class="member d-flex align-items-start p-3 bg-white shadow-sm rounded">
                        <div class="pic">
                            <img src="{{ $doctor->image }}" class="img-fluid rounded-circle" alt="{{ $doctor->name }}" />
                        </div>
  ...
  <section class="testimonials swiper">
    <div class="container">
        ...
        <swiper-container class="swiper-container mySwiperTestimonial" pagination="true" effect="coverflow" grab-cursor="true"
            centered-slides="true" :slides-per-view="1" :space-between="30" breakpoints='{
                "640": {
                    "slidesPerView": 1,
                    "spaceBetween": 20
                },
                ...
                <swiper-slide class="mb-5">
                    <div class="testimonial-wrap text-center p-3">
                        <div class="testimonial-item">
                            <img src="{{ asset($testimonial->image) }}" class="testimonial-img rounded-circle my-3" alt="{{ $testimonial->title }}" />
                            <p>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card packages-card">
                        <div class="card-body d-flex flex-column">
                            <h4 class="package-title text-center mt-3 mb-4">
                                {{ $package->title }}
                            </h4>
